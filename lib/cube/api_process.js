        ...
        try {
           ...
           */
            ...
            if (typeof pkg.browser === 'string') {
              ...
              tmpModPath = path.join(modPath, pkg.browser[pkg.main]);
            }
            debug('testModPath: try package.json.browser', tmpModPath);
          }
          /**
           * then search for main config in package.json
           * "module": "main.js"
           */
          else if (pkg.module) {
            tmpModPath = path.join(modPath, pkg.module);
            debug('testModPath: try package.json.module', tmpModPath);
          }
          /**
