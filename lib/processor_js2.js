...
var eswalker = require('esprima-walk');
    ...
    eswalker(ast, function (node) {
      ...
      */
      if (node.type === syntax.CallExpression) {
        // filter other property calls, like `abc[property]();`
        ...
        //
        // check if require() is redefined,
        // uglify can check if callee if defined
        // but esprima can't . so ignore now
