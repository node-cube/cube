...
function tryFiles(cube, root, modPath) {
  ...
  if (finalPath === '/Users/magong/WorkSpace/alibaba/app-console/assets/node_modules/antd/node_modules/react-slick/node_modules/react-responsive-mixin/node_modules/enquire.js') {
...
exports.processScript = function (cube, data) {
  ...
  estraverse.traverse(ast, {
    enter: function (node) {
      ...
      var resolvedRes;
      if (cube.config.moduleMap && cube.config.moduleMap[v]) {
        debug('hint moduleMap[', v, ',', cube.config.moduleMap[v],']');
        v = path.join(modPath, cube.config.moduleMap[v]);
      }
      v = cube.hook('beforeResolvePath', v);
      resolvedRes = (config.resolvePath || resolvePath)(cube, root, filepath, v, resolvePath);
